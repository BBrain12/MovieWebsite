...
# Saved-list storage is now in the SQLite DB for safety/multi-user support.
# We'll create a `saved` table (id, title, year, genre) and migrate any existing
# JSON list.json into it on startup.
